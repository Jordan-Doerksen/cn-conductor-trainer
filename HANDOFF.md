...
- **Honest rough edges (polish later):** puzzles are dig-out style only so far (no tight-room/build-outbound/multi-track jobs yet). Linked from the hub as a **"Game"** card (orange LED, `.tag.g`).
